...
PCA_PARAMS = 'flask_audio/audioset/vggish_pca_params.npz'  ## ****** BEWARE CHANGE on 9/20 - remove flask_audio/ to restore
VGG_CHECKPOINT = 'flask_audio/audioset/vggish_model.ckpt'
